...
const ContactUs = () => {
  ...
  return (
    ...
    <ContactInfo>
      <TabHeader>
        <TabButton active={activeTab === "munus"} onClick={() => setActiveTab("munus")}>
          MUNUS
        </TabButton>
        <TabButton active={activeTab === "ligala"} onClick={() => setActiveTab("ligala")}>
          LIGALA
        </TabButton>
      </TabHeader>
      ...
      {activeTab === "munus" && (
        <TabContent>
          ...
          <Address>339B Sembawang Close, #03-09, Sun Trellis Building, Singapore 7522339</Address>
          <Address><b>UEN:</b> 202520724N</Address>
          <BoardList>
            <BoardRow>
              <BoardMember>
      ...
      {activeTab === "ligala" && (
        <TabContent>
          ...
          <Address>339 Sembawang Close, #03-09, Sun Trellis Building, Singapore 7522339</Address>
          <Address><b>UEN:</b> 202523287Z</Address>
          <BoardList>
            <BoardRow>
              <BoardMember>
                <BoardPhoto src={ceo} alt="CEO" />
